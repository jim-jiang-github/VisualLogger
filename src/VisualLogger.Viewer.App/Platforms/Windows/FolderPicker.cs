...
namespace VisualLogger.Viewer.Platforms.Windows
{
    internal class FolderPicker : IFolderPicker
    {
        public async Task<string?> PickFolder()
        {
            ...
            if (VisualLogger.Viewer.App.App.Current == null || VisualLogger.Viewer.App.App.Current.Windows.Count <= 0)
            {
                return null;
            }
            var mauiWinUIWindow = VisualLogger.Viewer.App.App.Current.Windows[0].Handler.PlatformView as MauiWinUIWindow;
